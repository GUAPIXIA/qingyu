...
class OnlineChatRepository(
    ...
    override suspend fun getSessionMemory(sessionId: String): com.qingyu.companion.model.MemoryDto =
    ...
    override suspend fun summarizeMemory(sessionId: String): Pair<String, List<String>> {
        val resp = api().summarizeMemory(sessionId)
