...
interface ChatRepository {
    ...
    /** 读取会话记忆配置与内容 */
    suspend fun getSessionMemory(sessionId: String): com.qingyu.companion.model.MemoryDto
    ...
    /** 立即触发长记忆总结，返回 (摘要, 事实) */
    suspend fun summarizeMemory(sessionId: String): Pair<String, List<String>>

    /** 上下文用量（≥0.85 预警） */
    suspend fun getContextUsage(sessionId: String): com.qingyu.companion.model.ContextUsageDto
