...
/**
 * @deprecated 阶段 2 S2-04 过渡期兼容入口：仅写 journal、不包住业务文件写。
 * 供尚未收口的旧调用点（Bridge bridgeJournal.ts）暂用；Bridge 收口后与 bridgeJournal.ts 一并删除。
 * 新增调用点禁止使用，必须走 writeThroughDomain / deleteThroughDomain / commitThroughDomain。
 */
...
/** @deprecated 见 journalPutIfEnabled 说明 */
