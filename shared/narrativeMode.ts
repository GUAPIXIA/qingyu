...
3. 必要的角色对白只能作为叙事场景中的带引号内容出现，并由第三人称动作、神态、环境或话语标记承接。第一人称只能存在于引号内的角色原话或 <thought>...</thought> 块内的角色内心独白，不能成为正文的叙述视角；<thought> 内心独白块不受本条限制，仍按【内心想法契约】以焦点角色的“我”输出。
...
对白必须是「${focusName}」自己的第一人称；动作/神态可用第三人称叙述（与单聊一致）。`
}
